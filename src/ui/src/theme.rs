...
pub struct Theme {
  ...
  pub win_tint: Hsla,
  pub side: Hsla,
  /// The step between the centre and the project sidebar: the context sidebar,
  /// the tab strip and the status bar sit on it.
  pub panel_alt: Hsla,
  pub win_border: Hsla,
  pub panel: Hsla,
  pub panel2: Hsla,
  pub panel_border: Hsla,
  /// Between one region and the next. The same white alpha as `panel_border`, so
  /// the seam where two regions meet is no brighter than a border inside one of
  /// them — which is what the reference is careful about too.
  pub divider: Hsla,
  pub elevated: Hsla,
  pub hover: Hsla,
  pub active: Hsla,
...
pub fn sync_component_theme(cx: &mut App) {
  ...
  // `Root` fills the whole window with this, so it carries the blur alpha and the
  // window material shows through it. Every surface that wants a ground it can
  // rely on paints `win_tint` over the top; the project sidebar is the one that
  // does not, because it is sparse enough to read against a varying one.
...
/// The terminal is black in both themes, so its palette cannot follow the theme:
/// the light ANSI colours a light surface wants would be unreadable on it.
fn terminal_colors() -> TermColors {
  TermColors {
    bg: c(0x000000),
    fg: c(0xd6d6d6),
    cursor: c(0xd6d6d6),
...
impl Theme {
  ...
  pub fn dark() -> Self {
    Self {
      ...
      win_tint: c(0x0a0a0a),
      side: c(0x2a2a2a),
      panel_alt: c(0x171717),
      win_border: white(0.07),
      panel: white(0.05),
      panel2: white(0.03),
      panel_border: white(0.07),
      divider: white(0.07),
      elevated: white(0.15),
      // A white alpha lands on both of the reference's hover greys on its own:
      // 7% over the project sidebar's #2a2a2a, and over #171717 elsewhere.
      hover: white(0.07),
      active: white(0.14),
      overlay: fade(0x000000, 0.4),
      text: c(0xfafafa),
      text_muted: c(0xa1a1a1),
      text_dim: c(0x737373),
      accent: c(0xe5e5e5),
      accent_soft: white(0.1),
      accent_text: c(0x171717),
      claude: c(0xd97757),
      claude_soft: fade(0xd97757, 0.15),
      claude_text: c(0x1a1512),
      green: c(0x86efac),
      green_soft: fade(0x86efac, 0.12),
      red: c(0xff6568),
      yellow: c(0xf59e0b),
      yellow_soft: fade(0xf59e0b, 0.14),
      blue: c(0x60a5fa),
      blue_soft: fade(0x60a5fa, 0.16),
      purple: c(0xa78bfa),
      purple_soft: fade(0xa78bfa, 0.16),
      cyan: c(0x22d3ee),
      code_bg: c(0x1e1e1e),
      add_bg: fade(0x86efac, 0.08),
      del_bg: fade(0xff6568, 0.08),
      syntax_kw: c(0xa78bfa),
      syntax_str: c(0x86efac),
      syntax_num: c(0xfcd34d),
      syntax_fn: c(0x60a5fa),
      font_ui: "Geist".into(),
      font_mono: "Geist Mono".into(),
      font_term: "Geist Mono".into(),
      term: terminal_colors(),
    }
  }
  ...
  pub fn light() -> Self {
    Self {
      ...
      win_tint: c(0xffffff),
      side: c(0xf5f5f5),
      panel_alt: c(0xfafafa),
      win_border: c(0xe5e5e5),
      panel: c(0xf5f5f5),
      panel2: c(0xffffff),
      panel_border: c(0xe5e5e5),
      divider: c(0xe5e5e5),
      elevated: c(0xffffff),
      hover: ink(0.05),
      active: c(0xe5e5e5),
      overlay: fade(0x000000, 0.2),
      text: c(0x0a0a0a),
      text_muted: c(0x737373),
      text_dim: c(0xa1a1a1),
      accent: c(0x171717),
      accent_soft: ink(0.06),
      accent_text: c(0xfafafa),
      claude: c(0xc96442),
      claude_soft: fade(0xc96442, 0.13),
      claude_text: c(0xfdf6f2),
      green: c(0x16a34a),
      green_soft: fade(0x16a34a, 0.12),
      red: c(0xdc2626),
      yellow: c(0xd97706),
      yellow_soft: fade(0xd97706, 0.13),
      blue: c(0x2563eb),
      blue_soft: fade(0x2563eb, 0.14),
      purple: c(0x7c3aed),
      purple_soft: fade(0x7c3aed, 0.14),
      cyan: c(0x0891b2),
      code_bg: c(0xfafafa),
      add_bg: fade(0x16a34a, 0.09),
      del_bg: fade(0xdc2626, 0.07),
      syntax_kw: c(0x7c3aed),
      syntax_str: c(0x16a34a),
      syntax_num: c(0xd97706),
      syntax_fn: c(0x2563eb),
      font_ui: "Geist".into(),
      font_mono: "Geist Mono".into(),
      font_term: "Geist Mono".into(),
      term: terminal_colors(),
