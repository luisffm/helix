...
//!
//! Helix opts into parameterized mode. Auto's Intelligence / Balance / Cost
...
use helix_proto::{Model, ModelOption, ModelOptionChoice, ReasoningLevel};
...
/// Helix can render — so callers put it on the description subline (or fold
...
/// Rewrite the wire model list into Helix's picker shape.
...
/// Preference-ordered effort tokens for a Helix reasoning pick, used when
