  ...
  match color {
    ...
    AnsiColor::Named(named) => {
      ...
      match named {
        ...
        | NamedColor::DimCyan
        | NamedColor::DimWhite => CellColor::Indexed((ix - NamedColor::DimBlack as usize) as u8),
    ...
    (0..self.cols())
      .map(|col| {
        ...
        CellSnapshot {
          ...
          selected: selection.is_some_and(|range| range.contains(Point::new(line, Column(col)))),
        }
      })
      .collect()
  }
