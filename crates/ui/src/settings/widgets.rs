...
//! (helix settings.devices.tsx / settings.agents.tsx / settings.archived.tsx).
...
/// title + `text-[13px]` count sharing a baseline (helix settings.devices.tsx).
...
/// Display-only toggle switch (helix branch-picker.tsx `Toggle`): an 18×32
